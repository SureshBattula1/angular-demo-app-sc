      ...
      <div class="page-header">
        <div class="header-content">
          <h1>
            ...
            {{ isEditMode ? 'Edit Exam Term' : 'Create Exam Term' }}
          </h1>
          <p class="subtitle">{{ isEditMode ? 'Update exam term details' : 'Add a new exam term' }}</p>
        </div>
      </div>
          ...
          <form [formGroup]="termForm" (ngSubmit)="onSubmit()">
            <div class="form-row">
              <mat-form-field appearance="outline" class="full-width">
                ...
                <input matInput formControlName="name" placeholder="e.g., Term 1, Mid-Term">
            ...
            <div class="form-row">
              <mat-form-field appearance="outline" class="half-width">
                ...
                <input matInput formControlName="code" placeholder="e.g., TERM1-2024">
            ...
            <div class="form-row">
              ...
              <mat-form-field appearance="outline" class="half-width">
                ...
                <input matInput type="number" formControlName="weightage" placeholder="e.g., 30">
